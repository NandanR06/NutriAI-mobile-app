...
export interface ApiCatagaryCatagary extends Struct.SingleTypeSchema {
  collectionName: 'catagaries';
  info: {
    description: '';
    displayName: 'category';
    pluralName: 'catagaries';
    singularName: 'catagary';
  };
  options: {
...
export interface ApiUserListUserList extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    prefrence: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::catagary.catagary': ApiCatagaryCatagary;
